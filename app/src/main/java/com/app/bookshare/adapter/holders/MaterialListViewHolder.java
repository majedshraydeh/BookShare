...
public class MaterialListViewHolder extends RecyclerView.ViewHolder  {
    ...
    public MaterialListViewHolder(@NonNull ItemMaterialBinding itemMaterialBinding, PostListener postListener) {
...
//        itemMaterialBinding.unFavorite.setOnClickListener(view ->postListener.removeFavorite(view,getAdapterPosition(),itemMaterialBinding));
