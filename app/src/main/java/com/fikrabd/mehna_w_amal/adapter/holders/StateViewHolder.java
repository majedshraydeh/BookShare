...
public class StateViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    public StateViewHolder(@NonNull ItemStateBinding itemStateBinding, ItemClickListener itemClickListener) {
    ...
    public void onClick(View view) {
        if (itemClickListener != null)
            if (getAdapterPosition() != -1) {
                itemClickListener.onItemClick(new StateAdapter(), view, getAdapterPosition());
            }
    }
}
